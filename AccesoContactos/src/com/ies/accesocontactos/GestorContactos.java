...
public class GestorContactos {
	...
	public GestorContactos(ContentResolver cr){
		...
		while(!cursor.isAfterLast()){
			...
			int posTipo=cursor.getColumnIndex(ContactsContract.Data.MIMETYPE);
			String tipo=cursor.getString(posTipo);
			
			if(tipo.equals(ContactsContract.CommonDataKinds.Email.CONTENT_ITEM_TYPE)){
